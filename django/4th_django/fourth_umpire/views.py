...
def first_inn(request):
    if request.method == 'POST':
        ...
        if title_form.is_valid():
            ...
            run_predicted = int(predict_1st_inn(
                team1, team2, runs, 6*overs_played, 
                wickets,venue)) + 1
...
def second_inn(request):
    if request.method == 'POST':
        ...
        if title_form.is_valid():
            ...
            return render(request, 'fourth_umpire/secondinn.html', 
                context={'form2':title_form,   "winner":winner, 
                         "probab":probab,      "by_run":by_run, 
                         "by_wicket":by_wicket,"end":end})
